@echo off
REM =========================================================================
REM  AI Smart Drainage - Waste Detection (Phase 4)
REM  Real-Time Webcam Detection using the custom trained model (best.pt)
...
REM   4. Runs main.py (opens webcam + custom YOLO waste detection).
REM =========================================================================

echo ==============================================================
echo  AI Smart Drainage - Waste Detection (Phase 4)
echo  Real-Time Webcam Detection (Plastic / Organic / Metal)
echo ==============================================================
...
echo [INFO] Starting webcam waste detection ... Press Q in the video window to quit.
python main.py
